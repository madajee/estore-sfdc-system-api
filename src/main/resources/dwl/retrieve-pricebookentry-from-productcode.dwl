...
var condition2 = "AND Pricebook2Id = " ++ "'" ++ vars.opportunityrecord[0].Pricebook2Id as String ++ "'"
var condition3 = "AND CurrencyIsoCode = " ++ "'" ++ vars.opportunityrecord[0].CurrencyIsoCode as String ++ "'"
---
{
